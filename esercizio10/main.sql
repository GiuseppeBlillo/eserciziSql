...
VALUES
       ...
       (2, 'Grilled Chicken', FALSE, FALSE, FALSE, TRUE),
...
-- CREATE TABLE CUSTOMER (CUSTOMER_ID INT, NAME VARCHAR(255), ADDRESS VARCHAR(255));
-- CREATE TABLE ORDER (ORDER_ID INT, CUSTOMER_ID INT, ORDER_DATE DATE, TOTAL_COST DECIMAL(10,2));

-- -- -- -- -- -- -- -- -- --

-- CREATE TABLE PRODUCT (PRODUCT_ID INT, NAME VARCHAR(255), PRICE DECIMAL(10,2));
-- CREATE TABLE INVENTORY ( PRODUCT_ID INT, STORE_ID INT, QUANTITY INT);
