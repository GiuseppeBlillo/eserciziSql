...
CREATE TABLE VEGAN_INGREDIENT AS SELECT * FROM INGREDIENT WHERE VEGAN;

CREATE VIEW EXPENSIVE_MEALS AS SELECT * FROM MEAL WHERE PRICE >15;

CREATE VIEW LACTOSE_FREE_INGREDIENT AS SELECT * FROM INGREDIENT WHERE !CONTAINS_LACTOSE;

CREATE TABLE HIGH_CALORIES_MEALS AS SELECT * FROM MEAL WHERE CALORIES >650;
